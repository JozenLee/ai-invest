 ...
 * 展示Claude生成的完整趋势分析
 */
export function AIInsightSection({ trend, onGenerateAI, isGenerating = false }: AIInsightSectionProps) {
  // 检查是否有AI分析内容
  const hasAIContent = trend.allKeyDrivers && trend.allKeyDrivers.length > 0
